...
<body>
    ...
    <div class="main-title-container" style="border-bottom: none;">
        <h1 style="text-decoration: underline; margin-bottom: 5px;">Inventaire des logiciels</h1>
    </div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 25%;">Clé de licence</th>
                <th style="width: 25%;">Environnement</th>
        ...
        <tbody>
            @foreach($logiciels as $logiciel)
                <tr>
                    ...
                    <td>{{ $logiciel->designation_licence }}</td>
                    <td>{{ $logiciel->type_licence}}</td>
                    <td>{{ $logiciel->cle_licence }}</td>
                    <td>{{ $logiciel->environnement }}</td>
