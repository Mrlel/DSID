            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    <li class="breadcrumb-item">
                        <a href="{{ route('materiels.stock') }}" class="text-decoration-none">Stock matériel</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('equipement.details', $equipement->id) }}" class="text-decoration-none">
        ...
        <div class="col-lg-7">
            ...
            <div class="card border-0 bg-light mb-4">
                <div class="card-body py-3 d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-dark d-flex align-items-center justify-content-center"
                        ...
                        <i class="bi bi-pc-display text-white fs-5"></i>
                    </div>
                    <div>
                        <div class="fw-semibold">{{ $equipement->des_equipement }}</div>
                        <div class="small text-muted">
                            {{ $equipement->marque }} {{ $equipement->modele }} •
                            N° {{ $equipement->numero_serie }} •
                            <span class="badge bg-secondary">{{ $equipement->statut }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('sorties-equipements.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type_sortie" id="typeSortie"
                                ...
                                <option value="reforme" {{ old('type_sortie') == 'reformer' ? 'selected' : '' }}>
                                     Réforme 
                                </option>
                                ...
                                <option value="transfert" {{ old('type_sortie') == 'transfert' ? 'selected' : '' }}>
                                     Transfert vers autre direction
                                </option>
                            </select>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6" id="retourPrevuBlock">
                                ...
                                <div class="form-text">Uniquement pour maintenance externe</div>
                            </div>
                        </div>

                        <div class="row g-3 mb-4" id="prestataireBlock">
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            <a href="{{ route('equipement.details', $equipement->id) }}"
            ...
            <div class="card border-0 border-start border-4 border-warning shadow-sm">
                <div class="card-body">
                    ...
                    <ul class="small mb-0 ps-3">
                        <li class="mb-2">
                            <strong>Maintenance externe</strong> : l'équipement passe en statut "en maintenance".
                            Un retour sera attendu à la date prévue.
                        </li>
                        <li class="mb-2">
                            <strong>Réforme</strong> : l'équipement est définitivement retiré du parc
                            et passe en "hors service".
                        </li>
                        <li>
                            <strong>Transfert</strong> : l'équipement quitte la direction.
                            Assurez-vous que la direction destinataire est informée.
                        </li>
                    </ul>
                </div>
            </div>
