...
<div class="container-fluid">
  ...
  <p class="text-muted mb-0">
    Gestion des demandes de materiel • informatiques
  </p>
</header>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <a href="/usersEquipement/{{auth()->user()->id}}" 
       class="card border-0 shadow-sm p-5 position-relative stat-card text-decoration-none text-dark">
      ...
      <div class="d-flex justify-content-between align-items-start">
        <div>
          <h4 class="fw-bold text-muted mb-2">Mes Équipements</h4>
          <div class="d-flex align-items-baseline gap-2">
            <span class="fs-1 fw-bold text-dark">{{ $userEquipements->count() }}</span>
            <span class="small text-muted">Attribués</span>
          </div>
        </div>
      ...
      <div class="position-absolute bottom-0 end-0 opacity-25" style="width:100px; height:100px;">
        <i class="bi bi-pc-display" style="font-size:100px;"></i>
      </div>
    </a>
  </div>
                        ...
                        <td>
                            ...
                            @else
                                <form method="POST" action="{{ route('demande-materiel.cancel', $demande->id) }}">
                                    @csrf
                                    <button class="btn btn-sm btn-outline-danger" OnClick="return confirm('Voulez-vous vraiment rétirer cette demande ?')">Annuler</button>
                                </form>
                            @endif
                        </td>
                    </tr>
