  ...
  <p class="text-muted mb-0">
    Liste des demandes de maintenance • informatiques
  </p>
</header>
<a href="/list_maintenance"  class="btn text-white bg-success d-flex align-items-center gap-2 p-2">Historique des maintenances</a>
  </div>
...
<div class="row g-4 mb-4">
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card border-0 bg-light shadow-sm p-5 position-relative stat-card text-decoration-none text-dark">
      ...
      <div class="d-flex justify-content-between align-items-start">
        <div>
          <h4 class="fw-bold text-muted mb-2">Demandes approuvées ou traitées</h4>
          <div class="d-flex align-items-baseline gap-2">
            <span class="fs-1 fw-bold text-dark">{{ $demandesApprouvées }}</span>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card border-0 bg-light shadow-sm p-5 position-relative stat-card text-decoration-none text-dark">
      ...
      <div class="d-flex justify-content-between align-items-start">
        <div>
          <h4 class="fw-bold text-muted mb-2">Demandes en attente</h4>
          <div class="d-flex align-items-baseline gap-2">
            <span class="fs-1 fw-bold text-dark">{{ $demandesEnAttente }}</span>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card border-0 bg-light shadow-sm p-5 position-relative stat-card text-decoration-none text-dark">
      ...
      <div class="d-flex justify-content-between align-items-start">
        <div>
          <h4 class="fw-bold text-muted mb-2">Demandes rejetées</h4>
          <div class="d-flex align-items-baseline gap-2">
            <span class="fs-1 fw-bold text-dark">{{ $demandesRejetee }}</span>
