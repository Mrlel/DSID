            ...
            <div class="card-body py-5">
                <div class="empty-state fade-in text-center">
                    <div class="bg-light rounded-circle mx-auto mb-4 d-flex align-items-center justify-content-center" style="width: 120px; height: 120px;">
                        <i class="fas fa-desktop fs-1 opacity-75" style="color: #fd7e14;"></i>
                    </div>
                ...
                <i class="bi bi-plus-circle me-2"></i> Faire une demande d'equipement
            </button>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0">
             <header class="my-3">
                <h1 class="h3 fw-bold text-dark mb-1 d-flex align-items-center">
                    <i class="bi bi-pc-display fs-2 me-2"></i> Mes Equipements Informatiques
                </h1>
                <p class="text-muted mb-0">
                    Liste de mes Equipements • Attribués
                </p>
            </header>
